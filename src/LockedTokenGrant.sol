...
//   `address token_`: The address of Orbiter token ERC20 contract.
//   `address stakingContract_`: The address of the contrtact used for staking Orbiter token.
...
//   Global Time Lock:
//   ================
//   Orbiter token has a global timelock. Before that timelock expires, all the tokens in the grant
...
//   Staking:
//   =======
//   Staking of Orbiter tokens are exempted from the lock. I.e. Tokens from the locked grant
...
//     UUPSUpgradeable
// {
//     ERC20Upgradeable public immutable token;
//     uint256 public immutable grantAmount; // Total grant amount of token
...
//         require(
//             requestedAmount <= availableTokens(),
